...
def etl_pipeline(wiki_movies, kaggle_meta, kaggle_ratings):
    # Assumptions:
    #     1) column names in the input files do not change
    #     2) postgreSQL password does not change
    #     3) formats of the input columns do not change
    #     4) no additional forms are encountered in the currency and datetime columns that are parsed
    #     5) datatypes of columns do not change
    
    global movies_with_ratings_df, rating_counts, movies_df
    ...
    ratings = pd.read_csv(f'{file_dir}\{kaggle_ratings}')   
    ...
    wiki_movies_df['Language'].apply(lambda x: tuple(x) if type(x) == list else x).value_counts(dropna=False)

    # clean up the wiki movie titles
    ...
    #--------------------------------------------------------------------------
    # title_wiki               title_kaggle             drop wiki title
    ...
    # TRANSFORM reconcile similar fields in kaggle meta and wiki
    ...
    rating_counts.rename({ 0.5: 'rating_0_5',
                           1.0: 'rating_1_0',
                           1.5: 'rating_1_5',
                           2.0: 'rating_2_0',
                           2.5: 'rating_2_5',
                           ...
                           4.0: 'rating_4_0',
                           4.5: 'rating_4_5',
                           5.0: 'rating_5_0'}, axis='columns', inplace=True)
